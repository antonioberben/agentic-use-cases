...
Cuando la adopción escala, estos ficheros dejan de ser una buena práctica individual y se convierten en un **control inventariable**: qué agentes operan bajo qué reglas. Es uno de los puentes naturales hacia el Plan Director (identidad y control de agentes, Parte III de la Pieza 2).
