...
A escala, la gestión de contexto se vuelve un asunto de **coste y observabilidad**: cada token de contexto se paga, y el contexto que se inyecta a un agente es parte de lo que hay que poder auditar. Conecta con la gestión de coste (Parte III, cap. 14) y con la observabilidad (cap. 13) del Plan Director.
