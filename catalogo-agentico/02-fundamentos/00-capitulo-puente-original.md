...
Rampa de vocabulario para leer el resto del catálogo. No es un curso. No sustituye a Microsoft Learn, DeepLearning.ai ni Anthropic Academy.
...
El gobierno de IA a escala no prohíbe los niveles altos; los hace posibles con control.
...
- **MCP (Model Context Protocol).** Estándar para conectar agentes con herramientas y datos. Equivalente a "API estándar" en el mundo de los agentes. Trae interoperabilidad y nuevos vectores de riesgo. Controlar qué MCP usan tus agentes es central a la gobernanza a escala.
...
## 7. Cómo encaja en el resto del catálogo
...
- **Catálogo de casos de uso**: fichas de casos de uso, una por tarea de rol.
- **Labs**: walkthroughs didácticos por patrón técnico (no apps ejecutables).

La capa de gobierno reutiliza este vocabulario para definir adopción, gobierno, modelo de madurez y controles.
