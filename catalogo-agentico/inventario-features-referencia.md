# Inventario de features de referencia — Catálogo de IA agéntica
...
Recoger, de forma estructurada, las capacidades demostradas por aplicaciones públicas de referencia y mapearlas a (a) los **7 labs base** por patrón técnico (D11) y (b) la **base de conocimiento** del catálogo (manual por persona, guía de estándares, catálogo de casos). El objetivo no es clonar ninguna app, sino reutilizar sus patrones didácticos y de arquitectura.
...
| C7 | Observabilidad / traza como evidencia | Estado `trace` resalta el camino auditable de cada decisión. | Observabilidad y auditoría (gobierno a escala). |
...
| ID | Feature de UX | Descripción observada | Uso en el catálogo |
|----|---------------|------------------------|----------------|
...
| ID | Feature | Origen | Uso en el catálogo |
|----|---------|--------|----------------|
...
| Bloque del catálogo | Features aplicables | Cómo se usan |
|-------------------|---------------------|--------------|
