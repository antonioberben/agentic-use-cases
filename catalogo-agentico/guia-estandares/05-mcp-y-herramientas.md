...
Estos componentes se introducen en profundidad fuera de este catálogo (labs ejecutables reales). Aquí basta con que el practitioner entienda que **el punto donde el agente toca una herramienta es el punto donde se aplica el control.**
...
Este capítulo es la puerta directa al gobierno de IA a escala: control de herramientas y MCP, identidad de agentes y seguridad de LLMs y agentes. Lo que aquí es un hábito individual, allí es un control inventariable y auditable.
